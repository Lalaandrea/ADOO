...
\title{Reingeniería y Reutilización}
\author{
	ESCOM-IPN}
...
\begin{titlepage}
    ...
    {\fontsize{36}{50}                                              %Size of the book
        \selectfont \textbf{Reingeniería y Reutilización}}\\[0.5cm]       %Name of the book
    {\fontsize{36}{50}                                              %Size of the book
...
\clearpage
    ...
    Modificación de un producto software, o de ciertos componentes, usando para el análisis del sistema existente técnicas de ingeniería inversa y, para etapa de reconstrucción, herramientas de ingeniería directa, de tal manera que se oriente este cambio hacia mayores niveles de facilidad en cuento a manteinimiento, reutilización, compresión o evaluación.
    \subsection{Actividades}
    \begin{figure}[H]
               \centering
                \includegraphics[scale=1]{Reingenieria}
            \end{figure}
    \subsubsection{Análisis de inventario}
    ...
    \subsubsection{Reestructuración de documentos}
    ...
    \subsubsection{Ingeniería inversa}
    Es el proceso de análisis de un programa con el fin de crear una representación de programa con un nivel de abstracción más elevado que el código fuente.
    ...
    \subsubsection{Reestructuración de código}
    ...
    \subsubsection{Ingeniería directa}
    ...
    \begin{itemize}
        \item Especificaciones de requerimientos previamente concebidas
        \item Diseños previamente definidos.
        \item Código probado y depurado con anterioridad.
        \item Planes y casos de prueba previamente utilizados.
        \item Paquetes de software de proposito general.

    \end{itemize}
    \subsection{Ventajas}
    \begin{itemize}
        \item Reducir el tiempo de desarrollo y costos
        \item   Incrementar la productividad.
        \item Facilitar la compartición de productos del ciclo de vida.
        \item Mayor eficiencia y fiabilidad.
        \item Consistencia y la familiaridad, los patrones dentro del software serán más consistentes, tendiendo a facilitar el mantenimiento del producto.
    \end{itemize}
    \subsection{Desventajas}
    \begin{itemize}
        \item Necesidad de invertir antes de obtener resultados y carencia de métodos adecuados.
        \item Necesidad de formar al personal.
        \item Dificultad para institucionalizar los procesos.
    \end{itemize}
...
\begin{itemize}
    ...
    \item Esfuerzo a nivel organizacional y planificado de antemano
    \item Todo componente reutilizado ha de ser ideado, a priori, para ser reutilizado
    \item Implica inversiones iniciales para recoger frutos en el futuro
    \item Diseñar componentes genéricos para que sean reutilizados con facilidad
\end{itemize}
\subsubsection{Bottom-Up}
\begin{itemize}
    \item Se desarrollan pequeños componentes para una determinada aplicación
    \item Se incorpora a un repositorio
\end{itemize}
\subsubsection{Top-Down}
\begin{itemize}
    \item Se determinan las piezas necesarias que encajan unas con otras
    \item Se van desarrollando poco a poco
    \item Requiere alta inversión a comienzo
    \item Se recogerán beneficios en el futuro
\end{itemize}
